...
from ...domain.ports import LlmService, UserResolver
from ...infrastructure.database import PostgresRunner, SqliteRunner
from ...infrastructure.filesystem import LocalFileSystem
from ...infrastructure.llm import build_llm_service
...
class ToolRegistry:
    ...
    def register_local_tool(self, tool: any, access_groups: list[str]) -> None:
